...
"[project]/src/utils/searchHelper.ts [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getSearchWith(currentParams, paramsToUpdate) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$searchHelper$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/searchHelper.ts [client] (ecmascript)");
...
function useUpdateSearchParams() {
    ...
    const updateSearch = (params)=>{
        ...
        navigate({
            search: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$searchHelper$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["getSearchWith"])(searchParams, newParams)
        }, {
            state: {
                keepScroll: true
            }
...
_s(useUpdateSearchParams, "TWgzSyUhfR1qpSaKODBSa+lc2RA=", false, function() {
    return [
        useNavigate,
        useSearchParams
    ];
...
_s(Dropdown, "PKkHc7o1ClQ2i5FbMhHsTcjm0DI=", false, function() {
    return [
        useSearchParams,
...
_s(CatalogPage, "J9oYf1EQnug7ez8xAWcw2HYn9eM=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b5e1f536._.js.map